...
# 1. 模型和样本路径的设置
BOTTLENECK_TENSOR_SIZE = 2048   # 模型瓶颈层的节点个数
BOTTLENECK_TENSOR_NAME = 'pool_3/_reshape:0'
JPEG_DATA_TENSOR_NAME = 'DecodeJpeg/contents:0'


MODEL_DIR = 'E:\\MyProject\\Python\\datasets\\inception_dec_2015'
MODEL_FILE= 'tensorflow_inception_graph.pb'

CACHE_DIR = 'E:\\MyProject\\Python\\datasets\\bottleneck'
INPUT_DATA = 'E:\\MyProject\\Python\\datasets\\flower_photos'
